...
| `lib/data/models/affiliate_link.dart`, `lib/data/models/link_click.dart`, `lib/data/models/link_webhook.dart` | `shipglows_data/technical/app/flutter-app-shell-and-capture.md` | Affiliate link, click telemetry, webhook, conversion, and UTM payload parsing | Any link-management API payload or UI status contract change |
| `lib/presentation/screens/affiliations/affiliations_screen.dart`, `lib/presentation/screens/affiliations/affiliation_form_sheet.dart` | `shipglows_data/technical/app/flutter-app-shell-and-capture.md` | Affiliations list, expired badge, slug input, and click/variant/webhook/utm UI | Any affiliation UI, slug, click summary, variant-management, webhook, conversion, or UTM change |
