# ContentGlows Lab License Inventory
...
- Packages requiring normal notice/review if ContentGlows is redistributed as a packaged/on-prem product: `certifi`, `docutils`, `orjson`, `pyphen`, `tqdm`.
