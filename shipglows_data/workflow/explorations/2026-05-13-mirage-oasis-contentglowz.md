...
- `shipglows_data/workflow/explorations/2026-05-11-contentglowz-migration-remaining-ideas.md` - existing stance: contentglowz is inspiration only, not code to port.
