...
- [ ] Continue the scoped Flutter design-token migration; the Affiliations, Feedback, and Runs batch is code-authored with execution deferred, while design-drift enforcement remains owned centrally by ShipGlows (`Impact: High | Effort: Medium | Type: code-ready`).
