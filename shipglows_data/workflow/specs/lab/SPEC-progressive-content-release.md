...
supersedes: []
evidence: []
next_step: "/sf-docs audit shipglows_data/workflow/specs/lab/SPEC-progressive-content-release.md"
---
...
Tout utilisateur de ContentGlows qui :
...
### Ce qui existe deja dans ContentGlows
...
class DripPlan(BaseModel):
    id: str                          # UUID
    project_id: str                  # Projet ContentGlows
    user_id: str
...
5. Topical Mesh       ★★★★★       Agent existant dans ContentGlows
...
1. **Acces aux fichiers source** — ContentGlows Lab tourne sur un serveur. Comment accede-t-il aux fichiers Markdown du repo GoCharbon ? Options : git clone du repo, API GitHub pour modifier les fichiers, ou agent local sur la machine de build.
...
|------|----------|--------|
| 2026-04-06 | Le Content Drip est un module ContentGlows, pas un outil standalone | Reutilisable pour tous les projets, s'integre au scheduler et au mesh existants |
